...
const NavSideBar = () => {
  ...
  return (
    <div>
      ...
      <aside
        id="logo-sidebar"
        class="fixed top-0 left-0 z-30 w-56 h-screen pt-20 transition-transform -translate-x-full bg-white shadow-xl sm:translate-x-0"
        aria-label="Sidebar"
      >
        <div className="h-full px-3 pb-4 overflow-y-auto">
          <ul className="space-y-2 font-bold">
            ...
            />
            <ItemsList
              href={"/admin/coordinador/espacios"}
            ...
            <ItemsList
              href={"/admin/coordinador/eventos/"}
            ...
            />
            <ItemsList
              href={"/admin/coordinador/inventario"}
            ...
            />
            <ItemsList
              href={"/admin/coordinador/insumos"}
            ...
            />
            <ItemsList
              href={"/admin/coordinador/organizadores"}
